    ...
    return (
        ...
        <section className="pb-16 lg:py-24">
            <div className="container">
                <SectionHeader eyebrow="Real-word Results" title="Featured Projects" description="Lorem
                    ipsum, dolor sit amet consectetur adipisicing elit. Accusantium, perspiciatis.
                    Sunt, dolorum!"/>
                <div className="flex flex-col mt-10 gap-20 md:mt-20">
                    {portfolioProjects.map((project, projectIndex) => (
                        <Card
                            ...
                            style={{
                                top: `calc(78px + ${projectIndex * 40}px`  
                            }}
                        >
